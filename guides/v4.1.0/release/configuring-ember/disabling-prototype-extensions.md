...
* `String` is extended to add convenience methods, such as
  ...
  [Ember.String documentation](https://api.emberjs.com/ember/4.1.0/classes/String).
...
[`Ember.String` API reference](https://api.emberjs.com/ember/4.1.0/classes/String).
Instead,
...
Evented functions are annotated using [`Ember.on()`](https://api.emberjs.com/ember/4.1.0/classes/Evented/methods/on?anchor=on):
