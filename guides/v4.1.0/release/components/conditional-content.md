...
Please see the [API documentation of the `if` helper](https://api.emberjs.com/ember/4.1.0/classes/Ember.Templates.helpers/methods/if?anchor=if) for more patterns.
